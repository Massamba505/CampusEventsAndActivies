...
import { describe, it, expect, vi, beforeEach, afterEach } from 'vitest'; // Ensure vitest globals are imported
...
describe('DayView Component', () => {
  beforeEach(() => {
    ...
    global.scrollTo = vi.fn(); // Mock scrollTo
  });
  ...
  it('should display "No events for this day" when there are no events on the selected date', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/No events for this day/i)).toBeInTheDocument(); // Check for the message
    });
  });
